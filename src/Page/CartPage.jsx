  ...
  return (
    <>
      <div className="container">
        <div className="cartpage" style={{ margin: "50px auto", display: 'flex', justifyContent: 'center', gap: '45px', }}>
          {isCartEmpty ? (
            <div style={{ textAlign: 'center', margin:'100px' }}>
              <img src={cart} alt="Empty Cart"  style={{width:'100px'}} />
              <p style={{ fontSize: '28px' , margin:'50px'}}>Корзина пуста. Добавьте товары.</p>
            </div>
          ) : (
            <>
              <div
              className="cartpage-card"
